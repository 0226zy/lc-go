...
func TestAddTwoNumbers(t *testing.T) {
	tests := []struct {
		...
		// 关键用例：最后两位相加溢出，导致结果长度增加
		{"长度相同_最高位进位", []int{5, 6}, []int{5, 4}, []int{0, 1, 1}},       // 65+45=110
		{"长度相同_结果多一位", []int{9, 9}, []int{1, 0}, []int{0, 0, 1}},       // 99+1=100
		{"末尾进位传播", []int{9, 9, 9}, []int{1, 0, 0}, []int{0, 0, 0, 1}}, // 999+1=1000
		{"两个99相加", []int{9, 9}, []int{9, 9}, []int{8, 9, 1}},             // 99+99=198
